...
router.get('/', cek_login,async function(req, res) {
  res.render('content-backoffice/manajemen_ps/list'); 
});
router.get('/insert', cek_login, function(req, res) {
  res.render('content-backoffice/manajemen_ps/insert'); 
});
router.get('/edit/:id', cek_login, function(req, res) {
  res.render('content-backoffice/manajemen_ps/edit',{id:req.params.id}); 
});
