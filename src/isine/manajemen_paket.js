...
router.get('/', cek_login,async function(req, res) {
  res.render('content-backoffice/manajemen_paket/list'); 
});
router.get('/insert', cek_login, function(req, res) {
  res.render('content-backoffice/manajemen_paket/insert'); 
});
router.get('/edit/:id', cek_login, function(req, res) {
  res.render('content-backoffice/manajemen_paket/edit',{id:req.params.id}); 
});
